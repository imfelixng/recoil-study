...
const editSize = selectorFamily<any, {dimension: 'width' | 'height'; id: number}>({
    ...
    set: ({dimension, id}) => ({set, get}, newValue) => {
        ...
        if (dimension === 'width') {
            set(editPropertyState({path: 'style.size', id}), {
                width: newValue,
    ...
    return (
        <div>
            ...
            <InputGroup size="sm" variant="filled">
                <NumberInput value={value || 0} onChange={(_, value) => onChange(value)}>
    ...
    return (
        <Card>
            ...
            <Section heading="Size">
                <SizeProperty label="Widget" dimension="width" id={selectedElement} />
